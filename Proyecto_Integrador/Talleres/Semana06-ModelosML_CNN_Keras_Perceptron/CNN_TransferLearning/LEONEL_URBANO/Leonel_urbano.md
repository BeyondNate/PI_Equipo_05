...
* Esa misma arquitectura implementada con **Data Augmentation**.
* Un modelo de **Transfer Learning basado en ResNet18**.

Para concluir, evalué el desempeño de cada uno mediante métricas de clasificación y apliqué **Grad-CAM** para analizar visualmente qué zonas de las imágenes pesaron más en las decisiones del modelo.

---
🔗 **Acceso a los archivos del proyecto:** [Google Drive](https://drive.google.com/drive/folders/1NhWnbLmwBA1ga0VlqRTXR0tBQ_wgkJ8t?usp=sharing)
